...
// TriggerPreStartCommand is the command for listing all services of a given datastore type
type TriggerPreStartCommand struct {
...
func (c *TriggerPreStartCommand) Name() string {
	return "trigger-pre-start"
}

// Synopsis returns the synopsis of the command
func (c *TriggerPreStartCommand) Synopsis() string {
	return "Starts the services an app is linked to before it starts"
}

// Help returns the help text for the command
func (c *TriggerPreStartCommand) Help() string {
	return command.CommandHelp(c)
}

// Examples returns the examples for the command
func (c *TriggerPreStartCommand) Examples() map[string]string {
...
func (c *TriggerPreStartCommand) Arguments() []command.Argument {
...
func (c *TriggerPreStartCommand) AutocompleteArgs() complete.Predictor {
	return complete.PredictSet("redis")
}

// ParsedArguments parses the arguments for the command
func (c *TriggerPreStartCommand) ParsedArguments(args []string) (map[string]command.Argument, error) {
	return internal.ParseArguments(args, c.Arguments())
}

// FlagSet returns the flag set for the command
func (c *TriggerPreStartCommand) FlagSet() *flag.FlagSet {
...
func (c *TriggerPreStartCommand) AutocompleteFlags() complete.Flags {
...
func (c *TriggerPreStartCommand) Run(args []string) int {
