...
// TriggerPostAppCloneSetupCommand is the command for listing all services of a given datastore type
type TriggerPostAppCloneSetupCommand struct {
...
func (c *TriggerPostAppCloneSetupCommand) Name() string {
	return "trigger-post-app-clone-setup"
}

// Synopsis returns the synopsis of the command
func (c *TriggerPostAppCloneSetupCommand) Synopsis() string {
	return "Copies an app's service links onto its clone"
}

// Help returns the help text for the command
func (c *TriggerPostAppCloneSetupCommand) Help() string {
	return command.CommandHelp(c)
}

// Examples returns the examples for the command
func (c *TriggerPostAppCloneSetupCommand) Examples() map[string]string {
	appName := os.Getenv("CLI_APP_NAME")
	return map[string]string{
		"Copies the links from old-app onto new-app": fmt.Sprintf("%s %s redis old-app new-app", appName, c.Name()),
	}
}

// Arguments returns the arguments for the command
func (c *TriggerPostAppCloneSetupCommand) Arguments() []command.Argument {
...
func (c *TriggerPostAppCloneSetupCommand) AutocompleteArgs() complete.Predictor {
	return complete.PredictSet("redis")
}

// ParsedArguments parses the arguments for the command
func (c *TriggerPostAppCloneSetupCommand) ParsedArguments(args []string) (map[string]command.Argument, error) {
	return internal.ParseArguments(args, c.Arguments())
}

// FlagSet returns the flag set for the command
func (c *TriggerPostAppCloneSetupCommand) FlagSet() *flag.FlagSet {
...
func (c *TriggerPostAppCloneSetupCommand) AutocompleteFlags() complete.Flags {
...
func (c *TriggerPostAppCloneSetupCommand) Run(args []string) int {
