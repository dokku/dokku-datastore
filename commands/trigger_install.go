...
// TriggerInstallCommand is the command for listing all services of a given datastore type
type TriggerInstallCommand struct {
...
func (c *TriggerInstallCommand) Name() string {
	return "trigger-install"
}

// Synopsis returns the synopsis of the command
func (c *TriggerInstallCommand) Synopsis() string {
	return "Prepares the host for a datastore plugin"
}

// Help returns the help text for the command
func (c *TriggerInstallCommand) Help() string {
	return command.CommandHelp(c)
}

// Examples returns the examples for the command
func (c *TriggerInstallCommand) Examples() map[string]string {
	appName := os.Getenv("CLI_APP_NAME")
	return map[string]string{
		"Prepares the host for the redis plugin": fmt.Sprintf("%s %s redis", appName, c.Name()),
	}
}

// Arguments returns the arguments for the command
func (c *TriggerInstallCommand) Arguments() []command.Argument {
...
func (c *TriggerInstallCommand) AutocompleteArgs() complete.Predictor {
	return complete.PredictSet("redis")
}

// ParsedArguments parses the arguments for the command
func (c *TriggerInstallCommand) ParsedArguments(args []string) (map[string]command.Argument, error) {
	return internal.ParseArguments(args, c.Arguments())
}

// FlagSet returns the flag set for the command
func (c *TriggerInstallCommand) FlagSet() *flag.FlagSet {
...
func (c *TriggerInstallCommand) AutocompleteFlags() complete.Flags {
...
func (c *TriggerInstallCommand) Run(args []string) int {
	...
	if err := internal.Install(ctx, internal.InstallInput{
		Datastore: datastore,
		Logger:    logger,
	}); err != nil {
